    ...
    <div class="banner__green">
        ...
        <div class="shell">
            <div class="content__banner">
                ...
                <a href="" class="btn btn__green"> Escolha o seu plano </a>
            </div>
        </div>
    </div>
</template>
...
.banner__green {
    width: 100%;
    background-image: url(@/assets/images/green/banner-green-desktop.png);
    ...
    @media ($mobile) {
        background-image: url(@/assets/images/green/banner-green-mobile.png);
    }
